        ...
        <div className="py-12 md:py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            >
              <div className="flex items-center mb-4">
                <span
                  className={`${outfit.className} text-xl md:text-2xl font-bold text-indigo-600 bg-gradient-to-r from-indigo-600 to-blue-500 text-transparent bg-clip-text transition-all duration-700`}
                >
                  socialmat
                </span>
              </div>
              <p className={`${dmSans.className} text-gray-600 mb-6`}>
                Zvyšujeme prodeje brandům díky Instagramu a webu. Spojujeme sílu
                sociálních sítí a konverzního webu.
              </p>
              <div className="flex space-x-3 mb-6">
                <a
                  href="https://instagram.com/socialmat.cz"
                  target="_blank"
              ...
              <div className="text-gray-600 text-sm">
                <p className={`${dmSans.className} font-medium`}>
                  Socialmat je značka společnosti BITTERLOVE s.r.o.
                  <br />
                  IČO: 21977127
                  <br />
          ...
          <div className="border-t border-gray-200 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              >
                © {currentYear} BITTERLOVE s.r.o. Všechna práva vyhrazena.
                Socialmat je značka společnosti BITTERLOVE s.r.o.
              </motion.p>
              <motion.div
                initial={{ opacity: 0 }}
              ...
              >
                <Link
                  ...
                  className={`${dmSans.className} text-sm text-gray-500 hover:text-indigo-600 transition-colors`}
                >
                  Obchodní podmínky
                </Link>
                <Link
