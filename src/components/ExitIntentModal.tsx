            ...
            <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto">
              ...
              {isSuccess ? (
                ...
                <div className="p-8 text-center">
                  ...
                  <h2
                    className={`${outfit.className} text-2xl font-bold text-gray-900 mb-4`}
                  >
                    Perfektní! E-book je na cestě! 🎉
                  </h2>
                  <p className={`${dmSans.className} text-gray-600 mb-6`}>
                    E-book obdržíte během 5 minut na{" "}
                ...
                <div className="p-6">
                  ...
                  <div className="text-center mb-6">
                    ...
                    <p className={`${dmSans.className} text-gray-600 mb-4`}>
                      Než odejdete, stáhněte si zdarma e-book v hodnotě{" "}
                    ...
                    <div className="bg-gradient-to-r from-indigo-50 to-blue-50 border border-indigo-200 rounded-lg p-3 mb-4">
                      <h3
                        className={`${outfit.className} font-bold text-indigo-800 text-sm mb-2`}
                      >
                        📚 &quot;Proměňte svůj Instagram v automat na
                        peníze&quot;
                      </h3>
